...
func (r *HpaTunerReconciler) recentlyDownScaled(tuner *webappv1.HpaTuner) bool {
	...
	r.Log.V(1).Info("Checking if recently downscaled: ", "upscaleForbiddenWindow", upscaleForbiddenWindow, "lastDownscaleTime", tuner.Status.LastDownScaleTime) //TODO: null check on tuner.Status.LastDownScaleTime
